...
const cy_stc_smif_mem_cmd_t S25HS512T_SlaveSlot_0_readCmd =
{
...
const cy_stc_smif_mem_cmd_t S25HS512T_SlaveSlot_0_writeEnCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x06U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HS512T_SlaveSlot_0_writeDisCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x04U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HS512T_SlaveSlot_0_eraseCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0xDCU,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HS512T_SlaveSlot_0_chipEraseCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x60U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HS512T_SlaveSlot_0_programCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x12U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HS512T_SlaveSlot_0_readStsRegQeCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x35U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HS512T_SlaveSlot_0_readStsRegWipCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x05U,
    /* The width of the command transfer. */
...
const cy_stc_smif_mem_cmd_t S25HS512T_SlaveSlot_0_writeStsRegQeCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x01U,
    /* The width of the command transfer. */
...
static const cy_stc_smif_hybrid_region_info_t S25HS512T_SlaveSlot_0_region0 =
{
...
static const cy_stc_smif_hybrid_region_info_t S25HS512T_SlaveSlot_0_region1 =
{
    /* The region start address. */
...
static const cy_stc_smif_hybrid_region_info_t S25HS512T_SlaveSlot_0_region2 =
{
    /* The region start address. */
...
static const cy_stc_smif_hybrid_region_info_t * const S25HS512T_SlaveSlot_0_regionInfo[3] = {
   &S25HS512T_SlaveSlot_0_region0,
   &S25HS512T_SlaveSlot_0_region1,
   &S25HS512T_SlaveSlot_0_region2
};

#endif

const cy_stc_smif_mem_device_cfg_t deviceCfg_S25HS512T_SlaveSlot_0 =
{
    ...
    .readCmd = (cy_stc_smif_mem_cmd_t*)&S25HS512T_SlaveSlot_0_readCmd,
    /* Specifies the Write Enable command. */
    .writeEnCmd = (cy_stc_smif_mem_cmd_t*)&S25HS512T_SlaveSlot_0_writeEnCmd,
    /* Specifies the Write Disable command. */
    .writeDisCmd = (cy_stc_smif_mem_cmd_t*)&S25HS512T_SlaveSlot_0_writeDisCmd,
    /* Specifies the Erase command. */
    .eraseCmd = (cy_stc_smif_mem_cmd_t*)&S25HS512T_SlaveSlot_0_eraseCmd,
    /* Specifies the sector size of each erase. */
    .eraseSize = 0x0040000U,
    /* Specifies the Chip Erase command. */
    .chipEraseCmd = (cy_stc_smif_mem_cmd_t*)&S25HS512T_SlaveSlot_0_chipEraseCmd,
    /* Specifies the Program command. */
    .programCmd = (cy_stc_smif_mem_cmd_t*)&S25HS512T_SlaveSlot_0_programCmd,
    ...
    .readStsRegQeCmd = (cy_stc_smif_mem_cmd_t*)&S25HS512T_SlaveSlot_0_readStsRegQeCmd,
    /* Specifies the command to read the WIP-containing status register. */
    .readStsRegWipCmd = (cy_stc_smif_mem_cmd_t*)&S25HS512T_SlaveSlot_0_readStsRegWipCmd,
    /* Specifies the command to write into the QE-containing status register. */
    .writeStsRegQeCmd = (cy_stc_smif_mem_cmd_t*)&S25HS512T_SlaveSlot_0_writeStsRegQeCmd,
    ...
    .hybridRegionInfo = (cy_stc_smif_hybrid_region_info_t**)S25HS512T_SlaveSlot_0_regionInfo,
#else
...
const cy_stc_smif_mem_config_t S25HS512T_SlaveSlot_0 =
{
    ...
    .deviceCfg = (cy_stc_smif_mem_device_cfg_t*)&deviceCfg_S25HS512T_SlaveSlot_0,
#if (CY_IP_MXSMIF_VERSION >= 2)
