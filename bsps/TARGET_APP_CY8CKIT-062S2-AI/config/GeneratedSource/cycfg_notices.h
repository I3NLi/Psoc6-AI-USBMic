...
#endif /* !defined(CY8C624ABZI_S2D44) */
#endif /* defined(CY_SUPPORTS_DEVICE_VALIDATION) */

#if defined(CY_SUPPORTS_COMPLETE_DEVICE_VALIDATION)
#if !defined(CY8C624ABZI_S2D44)
#error "Unexpected MPN; expected DEVICE:=CY8C624ABZI-S2D44, ADDITIONAL_DEVICES:=CYW43439KUBG. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CY8C624ABZI_S2D44) */
#if !defined(CYW43439KUBG)
#error "Unexpected MPN; expected DEVICE:=CY8C624ABZI-S2D44, ADDITIONAL_DEVICES:=CYW43439KUBG. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CYW43439KUBG) */
